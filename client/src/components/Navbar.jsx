...
const Navbar = () => {
  ...
  return (
    <nav className="w-full flex md:justify-center justify-between items-center p-4">
      ...
      <ul className="text-white md:flex hidden flex-grow list-none flex-row justify-between items-center flex-initial">
      ...
      <div className="flex relative">
        ...
        {toggleMenu && (
          ...
          items-end rounded blue-glassmorphism text-white animate-slide-in"
          >
